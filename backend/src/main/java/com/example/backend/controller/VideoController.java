...
import com.example.backend.service.StreamBytesInfo;
...
public class VideoController {
    ...
    @GetMapping("/{id}")
    public VideoMetadataDto findVideoMetadataById(@PathVariable("id") Long id) {
    ...
    public ResponseEntity<Void> uploadVideo(NewVideoDto newVideoRepr) {
